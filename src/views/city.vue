        ...
        <div id="city-head">
            ...
            <div class="inp-box">
                ...
                <div class="search-box" ref="searched" v-show="keyword">
                    <div>
                        <div id="searchconbox">
                            <p v-for="item in listItem" @click="toRout(item.name)" :key="item.id"> {{item.name}}</p>
        ...
        <div class="wrapper" ref="wrapper">
            <div class="city-con-box">
                <div class="city-con">
                    ...
                    <div class="city-main">
                        <ul>
                            <li @click="toRout(clickCity)">{{clickCity}}</li>
                        </ul>
                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            hidePanel: function (event) {
                ...
                if (sp) {
                    //这句是说如果我们点击到了id为city-head以外的区域
                    if (!sp.contains(event.target) && !text.contains(event.target)) {
                        this.keyword = '';
                        // console.log(1)
                    }
